...
##
"""
EasyBuild support for gfbfc compiler toolchain (includes GCC,
...
class Gfbfc(Gccflexiblascuda, Gfbf):
    """
    Compiler toolchain with GCC, FlexiBLAS, FFTW (serial) and CUDA
    """
    NAME = 'gfbfc'
    SUBTOOLCHAIN = [Gccflexiblascuda.NAME, Gfbf.NAME]
    OPTIONAL = True
