...
cOMKL_2026 = [('iomkl', '2026'),('gomkl', '2026')]
...
new_version_mapping_2026 = {
        ('Boost', 'ANY', ''): ('1.82.0', COMPILERS_2026),
        ('Boost.MPI','ANY', ''): ('1.82.0', cOMPI_2026),
        ('Boost', '1.85.0', ''): ('1.85.0', COMPILERS_2026),
        ('CUDA', '12.2.2'): ('12.2', COMPILERS_2026),
        'CGAL': ('5.5.2', SYSTEM),
        ('CMake', '3.31.0') : ('3.31.0', SYSTEM),
        'CMake': ('3.27.7', SYSTEM),
        'ETSF_IO': ('1.0.4', [('iompi', '2026'), ('iccifort', '2020.1.217')]),
        ...
        ('HDF5','ANY',''): ('1.14.2', cOMPI_2026, '-mpi'),
        ('HDF5','ANY','-mpi'): ('1.14.2', cOMPI_2026, '-mpi'),
        ('HDF5','1.14.4',''): ('1.14.4', cOMPI_2026, '-mpi'),
        ('HDF5','1.14.4','-mpi'): ('1.14.4', cOMPI_2026, '-mpi'),
        ('HDF5','1.14.6'): ('1.14.6', COMPILERS_2026),
        ('HDF5','1.14.6','-mpi'): ('1.14.6', cOMPI_2026, '-mpi'),
        ...
        'libcerf': ('2.4', GCCCORE153),
        ('METIS', '5.1.0', ""): ('5.1.0', SYSTEM, '-64idx'),
        ('netCDF','ANY',""): ('4.9.2', COMPILERS_2026),
        ('netCDF','ANY',""): ('4.9.2', cOMPI_2026, '-mpi'),
        ('netCDF','ANY','-mpi'): ('4.9.2', cOMPI_2026, '-mpi'),
        ('netCDF-C++4','ANY', ""): ('4.3.1', COMPILERS_2026),
        ('netCDF-C++4','ANY', ""): ('4.3.1', cOMPI_2026, '-mpi'),
        ('netCDF-C++4','ANY','-mpi'): ('4.3.1', cOMPI_2026, '-mpi'),
        ('netCDF-Fortran','ANY', ""): ('4.6.1', COMPILERS_2026),
        ('netCDF-Fortran','ANY', ""): ('4.6.1', cOMPI_2026, '-mpi'),
        ('netCDF-Fortran','ANY','-mpi'): ('4.6.1', cOMPI_2026, '-mpi'),
        ('ParaView', '5.8.0'): ('5.8.0', [('gompi', '2026')], None),
        'Perl': ('5.36.1', SYSTEM),
        ('PLUMED', '2.6.0'): ('2.6.2', cOMKL_2026, None),
        'UDUNITS': ('2.2.28', SYSTEM),
        **dict.fromkeys([('Python', '3.13.%s' % str(x)) for x in range(0,16)], ('3.13', GCCCORE153 + SYSTEM)),
        **dict.fromkeys([('Python', '3.14.%s' % str(x)) for x in range(0,7)], ('3.14', GCCCORE153 + SYSTEM)),
        'Qt5': ('5.15.11', GCCCORE153 + SYSTEM),
        'SCOTCH': ('7.0.3', cOMPI_2026, None),
}
