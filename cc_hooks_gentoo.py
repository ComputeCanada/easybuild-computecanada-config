...
new_version_mapping_2020a = {
        ...
        ('Python', '2.7.18'): ('2.7', GCCCORE93),
        ('Python', '3.5.4'): ('3.7', GCCCORE93),
        ('Python', '3.6.3'): ('3.6', GCCCORE93),
        ('Python', '3.6.10'): ('3.6', GCCCORE93),
        ('Python', '3.7.0'): ('3.7', GCCCORE93),
        ('Python', '3.7.2'): ('3.7', GCCCORE93),
        ('Python', '3.7.4'): ('3.7', GCCCORE93),
        ('Python', '3.7.7'): ('3.7', GCCCORE93),
        ('Python', '3.8.0'): ('3.8', GCCCORE93),
        ('Python', '3.8.2'): ('3.8', GCCCORE93),
